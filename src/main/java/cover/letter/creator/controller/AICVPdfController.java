...
public class AICVPdfController {
    ...
    public ResponseEntity<String> generatePdf(@RequestBody AICVPdfRequest request) {
        try {
            ...
            MultipartFile multipartFile = new CustomMultipartFileAICV(fileName, pdfBytes);
            ...
            aicvPdfService.saveAICVPdf(fileId, id, templateName);
...
class CustomMultipartFileAICV implements MultipartFile {
    private final String name;
    private final byte[] content;

    public CustomMultipartFileAICV(String name, byte[] content) {
        this.name = name;
